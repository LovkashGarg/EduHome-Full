...
<div className='text-[25px] bg-orange-600 ml-[30px]  my-[10px] w-[240px] text-white flex items-center text-center justify-center'>{Email}</div>
<div className='text-[25px] bg-green-500 ml-[30px] mb-[10px]  w-[240px] text-white flex items-center justify-center'>{Role}</div>
</div>
